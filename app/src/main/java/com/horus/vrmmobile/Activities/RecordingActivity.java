...
import com.horus.vrmmobile.recorder.RecorderPreferences;
import com.horus.vrmmobile.recorder.RawSamples;
import com.horus.vrmmobile.recorder.RecorderUtils;
import com.horus.vrmmobile.recorder.Sound;
import com.horus.vrmmobile.recorder.Storage;
import com.horus.vrmmobile.recorder.encoders.Encoder;
import com.horus.vrmmobile.recorder.encoders.EncoderInfo;
import com.horus.vrmmobile.recorder.encoders.FileEncoder;
import com.horus.vrmmobile.recorder.encoders.Format3GP;
import com.horus.vrmmobile.recorder.encoders.FormatM4A;
import com.horus.vrmmobile.recorder.encoders.FormatWAV;
import com.horus.vrmmobile.recorder.widgets.PitchView;
...
//        if (shared.getBoolean(RecorderPreferences.PREFERENCE_CALL, false)) {
...
//        }
        ...
        sampleRate = Integer.parseInt(RecorderPreferences.PREFERENCE_RATE);
...
//        state.setText(s + "\n(" + RecorderUtils.formatFree(this, free, sec) + ")");
        state.setText(s);
    }
    ...
    void cancelDialog(final Runnable run) {
        AlertDialog.Builder builder = new AlertDialog.Builder(this, R.style.AlertDialogRecorder);
...
//        RecordingService.startService(this, targetFile.getName(), thread != null);
    ...
    void updateSamples(long samplesTime) {
        ...
        time.setText(RecorderUtils.formatDuration(this, ms));
    }
...
//                edit.putString(RecorderPreferences.PREFERENCE_LAST, out.getName());
//                edit.commit();
    ...
    public void finishResult() {
        ...
        data.putExtra("filePath", targetFile.getAbsolutePath());
